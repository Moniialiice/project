...
Class Grupo{
    ...
    public function createGrupo($grupo, $avatar, $orden){
        echo"Crear Materia<br>";
        $query="INSERT INTO grupo (grupo, avatar, orden, estatus)
                      VALUES ('$grupo' ,'$avatar', '$orden', 1)";
    ...
    public function readGrupo(){
        ...
        while($field=mysql_fetch_array($result)){
            ...
            echo"<tbody>";
            echo"<tr>";
            echo"<td>".$this->idgrupo."</td>";
            echo"<td>".$this->grupo."</td>";
    ...
    public function updateGrupo($idgrupo, $grupo, $avatar, $orden){
        echo"Modificar Grupo<br>";
        $query="UPDATE Grupo SET grupo='$grupo',avatar='$avatar',orden='$orden' WHERE idgrupo=$idgrupo";
        $result=mysql_query($query)or die ("error de consulta");
        echo"Registro Actualizado correctamente<br>";
    }
    public function deleteGrupo($id_del){
        echo"Eliminar Grupo<br>";
        $query="DELETE FROM grupo  WHERE  idgrupo=$id_del";
        $result=mysql_query($query)or die ("error de consuiñltyasuygf");
        echo"Registro eliminado correctamente<br>";

    }
    public function viewGrupo($id_user){
        echo"Ver Grupo Especifico<br>";
        $query="SELECT * FROM grupo WHERE  estatus='1' AND idgrupo=$id_user";
        $result=mysql_query($query)or die ("error de consuiñltyasuygf");
        echo"<table class='table table-striped'>
                    <thead>
                        <tr>
    ...
    public function muestratea(){
        ...
        if(mysql_num_rows($result)>0){
            ...
            for($y=0; $y<mysql_num_rows($result); $y++){
                ...
                echo"</tr>";
                echo"<td>".mysql_result($result,$y,'materia')."</td><td><a href='Asignagrupo.php?id=$idmat&idu=$idusuario' ><img src='eliminar.png' width='30px'	height='30px'></a></td></tr></tr>";
            }
            echo"</table>";
        }
        else{
